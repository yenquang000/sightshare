...
export default function Team() {
  return (
    <section id="team" className="bg-gray-50 py-16  dark:bg-transparent">
      <div className="mx-auto max-w-5xl">
        {/* current team members */}
        <div className="mt-12 gap-4">
          <div className="w-full text-center">
            <h2 className="text-3xl font-bold sm:text-4xl font-serif font-bold text-[#59769d]">
              Our Team
            </h2>
          </div>
          <div className="w-full text-center">
        ...
        <div>
          <div className="w-full text-center mt-12">
            <h2 className="mt-12 text-3xl font-bold sm:text-4xl font-serif font-bold text-[#59769d]">
              Our Alumna
            </h2>
          </div>
        </div>
