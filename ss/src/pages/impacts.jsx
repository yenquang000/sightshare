  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
        <h2 className="text-4xl font-medium lg:text-5xl text-[#59769d] font-serif">
          Sightshare in numbers
        </h2>
        <p className="text-[#59769d]">
      ...
      <div>
        ...
        <div className="grid gap-8 md:grid-cols-4 text-[#abc9df]">
          {[
            {
            ...
            <div
              key={index}
              className="flex h-full flex-col rounded-xl bg-white p-6 shadow-md text-center"
            >
