...
function ControlGroup({ children }) {
  return (
    <div className="flex flex-col rounded-md border border-border bg-white shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-border">
      {children}
    </div>
  );
}
